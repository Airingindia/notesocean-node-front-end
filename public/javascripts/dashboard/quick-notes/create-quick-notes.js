$(document).ready(function () {
	...
	$(".share-btn").click(function () {
		...
		setTimeout(function () {
			$(".share-btn").html(
				" <i class='fa fa-share mx-1'> </i> <span> Share </span>"
			);
		}, 5000);
	});
	...
	function savingChanges() {
		...
		$(".ql-toolbar").css({
			background:
				"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 50%, rgba(255,255,255,0.5) 100%) !important",
		});
	}
	...
	function savedChanges() {
		...
		$(".ql-toolbar").css({
			background:
				"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 50%, rgba(255,255,255,1) 100%) !important",
		});
	}
