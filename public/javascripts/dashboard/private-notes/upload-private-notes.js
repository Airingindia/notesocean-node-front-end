...
$(function () {
    ...
    var myDropzone = new Dropzone(".dropzone", {
        ...
        acceptedFiles: ".pdf,.txt,.png,.jpg,.jpeg,.doc,.docx,.xls,.xls,.ppt,.pptx,.webp,.gif,.ai,.psd",
        ...
        success: function (data) {
            ...
            $(".notice-box").html(` <div id="liveToast" class="toast fade show border-0" role="alert" aria-live="assertive" aria-atomic="true">
                ...
                <div class="toast-body">
                  <span class="text-danger mx-1"> ${data.name} </span>  <span>  uploaded successfully </span> 
                </div>
            </div>`);
